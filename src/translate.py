...
class Kengee(object):
    def __init__(self):
        # TODO 启动代理
        server = Server(r"/Users/pokemon/Documents/webdriver/browsermob-proxy-2.1.4/bin/browsermob-proxy")
        server.start()
    ...
    def saveall(self):
        """存储题目和答案列表"""
        time.sleep(0.39)
        self.dr.find_element_by_id('5ebe11f93631f27cbbb79679').send_keys('test_name')
        self.dr.find_element_by_id('5ebe12173631f27bad72c2f1').send_keys('test_number')
        self.dr.find_element_by_id('5ebe121b92beb5614a270460').send_keys('test_name')
        self.dr.find_element_by_id('5ebe121f92beb56237aaaf37').send_keys('test_store')
